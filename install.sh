...
VALIDITY () {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/erlkim/key/main/ip | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl https://raw.githubusercontent.com/erlkim/key/main/ip | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
echo -e "             ${green}Telegram t.me/erlkim "
...
function password_default() {
    ...
    <code>User Login :</code> <code>erlkim</code>
    <code>Pass Login :</code> <code>erlkim</code>
